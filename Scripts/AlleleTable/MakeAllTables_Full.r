...
alleleTable.format = fread("/project8/HessLabCHGPM/Users/ghess3/BEChar/FinalData/FastqProcessing/Data/AlleleTables/Transfect/Transfect_AlleleTable_Norm.tsv",stringsAsFactors = F, select=c(25, 26, 27, 30, 18, 20, 14, 16, 22, 23, 5, 4, 6, 3, 8, 1,24, 29, 28))
...
write.table(p.merge2, "/project8/HessLabCHGPM/Users/ghess3/BEChar/FinalData/FastqProcessing/Data/AlleleTables/Transfect/K562-sg200_Transfect_AlleleTable_propDiff.tsv", col.names = T, row.names = F, sep = "\t", quote= F)
...
# Output File
write.table(subs.sep,"/project8/HessLabCHGPM/Users/ghess3/BEChar/FinalData/FastqProcessing/Data/AlleleTables/Transfect/K562-sg200_Transfect_AlleleTable_Subs.tsv", col.names = T, row.names = F, sep = "\t", quote= F)
